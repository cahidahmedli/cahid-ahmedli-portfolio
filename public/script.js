...
const translations = {
  az: {
    ...
    career: 'Karyera', experienceTitle: 'Təcrübə', clientsShort: 'Klientlər', clientsTitle: 'Birlikdə işlədiyim brendlər', present: 'indi', investmentCompany: 'İnvestisiya şirkəti · Tam ştat', independent: 'Müstəqil',
  ...
  en: {
    ...
    career: 'Career', experienceTitle: 'Experience', clientsShort: 'Clients', clientsTitle: 'Brands I have worked with', present: 'present', investmentCompany: 'Investment company · Full-time', independent: 'Independent',
